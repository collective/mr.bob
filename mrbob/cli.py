...
parser.add_argument(
    "-V", "--version", action="store_true", default=False, help="Display version number"
)
parser.add_argument(
    "-l",
    "--list-questions",
...
def main(args=sys.argv[1:]):
    ...
    bobconfig = update_config(
        update_config(global_bobconfig, file_bobconfig), cli_bobconfig
    )
